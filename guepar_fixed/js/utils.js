// =====================================================================
// UTILITÁRIOS — helpers pequenos e sem estado próprio, usados por
...
export const abrirModal = id => $(id).classList.remove('hidden');
export const fecharModal = id => $(id).classList.add('hidden');
